...
from allrank.loss_utils import deterministic_neural_sort, sinkhorn_scaling, stochastic_neural_sort
from  allrank.metrics.metrics import dcg
from allrank.model_utils import get_torch_device
PADDED_Y_VALUE = -1
DEFAULT_EPS = 1e-10
...
def neuralNDCG(y_pred, y_true, padded_value_indicator=PADDED_Y_VALUE, temperature=1., powered_relevancies=True, k=None,
    ...
    return -mean_ndcg  # -1 cause we want to maximize NDCG
